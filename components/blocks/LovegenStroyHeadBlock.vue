<template>
  <div class="lovegen-story" v-if="compData">
    ...
    <div class="row new-wrap-content">
      ...
      <div class="col-md-12 col-lg-6 col-xl-6 pr-0 mobile-space">
        <div class="right-img">
...
@Component({
  name: "LovegenStroyHeadBlock",
  components: {},
})
export default class LovegenStroyHeadBlock extends Vue {
  @Prop() compData: any;
  get HOST() {
