...
export type Attribute = Node & ObjectWithMetadata & {
  ...
  /** Whether this attribute has support for color and texture values. */
...
/** Represents a value of an attribute. */
export type AttributeValueTextureArgs = {
  size?: Maybe<Scalars['Int']>;
  rendition?: Maybe<Scalars['String']>;
};
...
export type AttributeFilterInput = {
  ...
  inCollectionBySlug?: Maybe<Scalars['String']>;
  inCategory?: Maybe<Scalars['ID']>;
  inCategoryBySlug?: Maybe<Scalars['String']>;
};
...
export type Category = Node & ObjectWithMetadata & {
  ...
  sizeChart?: Maybe<Scalars['GenericScalar']>;
...
/** Represents a single category of products. Categories allow to organize products in a tree-hierarchies which can be used for navigation in the storefront. */
export type CategorySizeChartArgs = {
  size?: Maybe<Scalars['Int']>;
  rendition?: Maybe<Scalars['String']>;
};
...
export type Checkout = Node & ObjectWithMetadata & {
  ...
  /** The price of the shipping, with all the taxes included. */
  shippingPriceLocalCurrency?: Maybe<TaxedMoney>;
  /** The price of the checkout before shipping, with taxes included. */
  subtotalPrice?: Maybe<TaxedMoney>;
  /** The price of the checkout before shipping, with taxes included in local currency. */
  subtotalPriceLocalCurrency?: Maybe<TaxedMoney>;
  /** The checkout's token. */
  token: Scalars['UUID'];
  /** The sum of the the checkout line prices, with all the taxes,shipping costs, and discounts included. */
  totalPrice?: Maybe<TaxedMoney>;
  /** The sum of the checkout line price, taxes and discounts in local currency. */
  totalPriceLocalCurrency?: Maybe<TaxedMoney>;
};
...
export type CategoryFilterInput = {
  ...
  ids?: Maybe<Array<Maybe<Scalars['ID']>>>;
  inCollectionBySlug?: Maybe<Scalars['String']>;
  inCollection?: Maybe<Scalars['String']>;
  onSale?: Maybe<Scalars['Boolean']>;
};
...
export type Mutation = {
  ...
  /** Request resend confirmation url */
  requestConfirmationEmail?: Maybe<ResendConfirmationEmail>;
...
export type MutationRequestConfirmationEmailArgs = {
...
export type AttributeValueCreateInput = {
  ...
  name: Scalars['String'];
  value?: Maybe<Scalars['String']>;
  /** Texture Image File file. */
  texture?: Maybe<Scalars['Upload']>;
};
...
export type CategoryInput = {
  ...
  /** Size Chart image file. */
  sizeChartImage?: Maybe<Scalars['Upload']>;
  sizeChartData?: Maybe<Scalars['GenericScalar']>;
};
...
/** Request resend confirmation url */
export type ResendConfirmationEmail = {
  __typename?: 'ResendConfirmationEmail';
...
export type CategoryPriceRangeQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type CategoryPriceRangeQuery = (
  { __typename?: 'Query' }
  & { min?: Maybe<(
    { __typename?: 'ProductCountableConnection' }
    & { edges: Array<(
...
export type AttributesQuery = (
  ...
  & { attributes?: Maybe<(
    ...
    & { edges: Array<(
      ...
      & { node: (
        { __typename?: 'Attribute' }
        & Pick<Attribute, 'id' | 'name' | 'slug' | 'isColor'>
        & { values?: Maybe<Array<Maybe<(
          { __typename?: 'AttributeValue' }
          & Pick<AttributeValue, 'id' | 'slug' | 'name' | 'value'>
        )>>> }
      ) }
    )> }
  )> }
...
export type CategoryQuery = (
  ...
  & { category?: Maybe<(
    { __typename?: 'Category' }
    & Pick<Category, 'seoTitle' | 'seoDescription'>
    & { ogImage?: Maybe<(
      { __typename?: 'Image' }
      & Pick<Image, 'url' | 'alt'>
    )>, children?: Maybe<(
...
export type GenderCategoryQueryVariables = Exact<{
  slug?: Maybe<Scalars['String']>;
}>;


export type GenderCategoryQuery = (
  { __typename?: 'Query' }
  & { category?: Maybe<(
    { __typename?: 'Category' }
    & Pick<Category, 'id' | 'name' | 'slug'>
...
export type CollectionBasicFragment = (
  { __typename?: 'Collection' }
  & Pick<Collection, 'id' | 'name' | 'slug' | 'isPublished'>
  & { metadata: Array<Maybe<(
    { __typename?: 'MetadataItem' }
    & MetadataFragment
  )>> }
...
export type CollectionQuery = (
  ...
  & { collection?: Maybe<(
    { __typename?: 'Collection' }
    & Pick<Collection, 'seoTitle' | 'seoDescription'>
    & { ogImage?: Maybe<(
      { __typename?: 'Image' }
      & Pick<Image, 'url' | 'alt'>
    )> }
...
export type AttributeBasicFragment = (
  { __typename?: 'Attribute' }
  & Pick<Attribute, 'id' | 'name' | 'slug' | 'isColor'>
  & { values?: Maybe<Array<Maybe<(
    { __typename?: 'AttributeValue' }
...
export type OnSaleQueryVariables = Exact<{ [key: string]: never; }>;
...
export type AttributesFragmentFragment = (
  { __typename?: 'SelectedAttribute' }
  & { attribute: (
    { __typename?: 'Attribute' }
    & Pick<Attribute, 'name'>
...
export type MoneyFragmentFragment = (
  { __typename?: 'Money' }
  & Pick<Money, 'currency' | 'amount' | 'localized'>
);
...
export type ProductListFragmentFragment = (
  ...
  & { pageInfo: (
    ...
    & { node: (
      { __typename?: 'Product' }
      & { imgOriginal?: Maybe<Array<Maybe<(
        { __typename?: 'ProductImage' }
        & Pick<ProductImage, 'url' | 'alt'>
      )>>>, imgMobile?: Maybe<Array<Maybe<(
        { __typename?: 'ProductImage' }
...
export type VariantFragmentFragment = (
  { __typename?: 'ProductVariant' }
  & Pick<ProductVariant, 'id' | 'sku' | 'isAvailable'>
  & { attributes: Array<(
    { __typename?: 'SelectedAttribute' }
    & { attribute: (
      { __typename?: 'Attribute' }
      & Pick<Attribute, 'name' | 'slug' | 'id' | 'isColor'>
    ), values: Array<Maybe<(
      { __typename?: 'AttributeValue' }
      & Pick<AttributeValue, 'id' | 'slug' | 'name' | 'value'>
    )>> }
...
export type ProductDataQuery = (
  ...
  & { product?: Maybe<(
    { __typename?: 'Product' }
    & Pick<Product, 'id' | 'slug' | 'name' | 'descriptionJson' | 'seoTitle' | 'seoDescription' | 'isAvailable' | 'isAvailableForPurchase'>
    & { collections?: Maybe<Array<Maybe<(
      { __typename?: 'Collection' }
      & CollectionBasicFragment
    )>>>, attributes: Array<(
      { __typename?: 'SelectedAttribute' }
      & AttributesFragmentFragment
    )>, ogImage?: Maybe<(
      { __typename?: 'Image' }
      & Pick<Image, 'url'>
    )>, originalImg?: Maybe<Array<Maybe<(
      { __typename?: 'ProductImage' }
      & Pick<ProductImage, 'url' | 'alt'>
    )>>>, optimalImg?: Maybe<Array<Maybe<(
      { __typename?: 'ProductImage' }
      & Pick<ProductImage, 'url'>
    )>>>, mobileZoomImg?: Maybe<Array<Maybe<(
      { __typename?: 'ProductImage' }
      & Pick<ProductImage, 'url'>
    )>>>, defaultImg?: Maybe<Array<Maybe<(
      { __typename?: 'ProductImage' }
      & Pick<ProductImage, 'url' | 'alt'>
    )>>>, mobileImg?: Maybe<Array<Maybe<(
      { __typename?: 'ProductImage' }
      & Pick<ProductImage, 'url' | 'alt'>
    )>>>, category?: Maybe<(
      { __typename?: 'Category' }
      & Pick<Category, 'sizeChart'>
      & CategoryBasicFragment
    )>, pricing?: Maybe<(
      { __typename?: 'ProductPricingInfo' }
      & Pick<ProductPricingInfo, 'onSale'>
      & { discountLocalCurrency?: Maybe<(
        { __typename?: 'TaxedMoney' }
        & PriceFragment
      )>, priceRange?: Maybe<(
        { __typename?: 'TaxedMoneyRange' }
...
export type AddressFragmentFragment = (
  { __typename?: 'Address' }
  & Pick<Address, 'id' | 'firstName' | 'lastName' | 'streetAddress1' | 'streetAddress2' | 'city' | 'cityArea' | 'countryArea' | 'postalCode' | 'phone'>
  & { country: (
    { __typename?: 'CountryDisplay' }
...
export type CheckoutFragmentFragment = (
  { __typename: 'Checkout' }
  & Pick<Checkout, 'id' | 'discountName' | 'voucherCode' | 'token'>
  & { lines?: Maybe<Array<Maybe<(
    ...
    { __typename?: 'TaxedMoney' }
    & PriceFragment
  )>, totalPriceLocalCurrency?: Maybe<(
    { __typename?: 'TaxedMoney' }
    & PriceFragment
  )>, totalPrice?: Maybe<(
    { __typename?: 'TaxedMoney' }
    & PriceFragment
  )>, shippingPriceLocalCurrency?: Maybe<(
    { __typename?: 'TaxedMoney' }
    & PriceFragment
  )>, discount?: Maybe<(
    { __typename?: 'Money' }
    ...
    { __typename?: 'PaymentGateway' }
    & PaymentGatewayFragmentFragment
...
export type OrderDetailFragmentFragment = (
  { __typename: 'Order' }
  & Pick<Order, 'id' | 'number' | 'created' | 'status' | 'statusDisplay' | 'shippingMethodName' | 'paymentStatusDisplay'>
  & { lines: Array<Maybe<(
    { __typename?: 'OrderLine' }
    & OrderLineDetailFragmentFragment
  )>>, user?: Maybe<(
    { __typename?: 'User' }
...
export type OrderLineDetailFragmentFragment = (
  { __typename: 'OrderLine' }
  & Pick<OrderLine, 'id' | 'productName' | 'variantName' | 'productSku' | 'isShippingRequired' | 'quantity'>
  & { unitPrice?: Maybe<(
    { __typename?: 'TaxedMoney' }
    & PriceFragment
  )>, totalPrice?: Maybe<(
...
export type OrderLineFragmentFragment = (
  { __typename: 'OrderLine' }
  & Pick<OrderLine, 'id' | 'productName' | 'variantName' | 'productSku' | 'isShippingRequired' | 'quantity'>
  & { unitPrice?: Maybe<(
    { __typename?: 'TaxedMoney' }
...
export type PaymentGatewayFragmentFragment = (
  { __typename?: 'PaymentGateway' }
...
export type ShippingMethodFragmentFragment = (
  { __typename?: 'ShippingMethod' }
  & Pick<ShippingMethod, 'id' | 'name' | 'type'>
  & { price?: Maybe<(
    { __typename?: 'Money' }
    & Pick<Money, 'amount' | 'currency'>
  )>, minimumOrderPrice?: Maybe<(
    { __typename?: 'Money' }
    & MoneyFragmentFragment
  )>, maximumOrderPrice?: Maybe<(
    { __typename?: 'Money' }
    & MoneyFragmentFragment
  )>, minimumOrderWeight?: Maybe<(
    { __typename?: 'Weight' }
    & Pick<Weight, 'unit' | 'value'>
  )>, maximumOrderWeight?: Maybe<(
    { __typename?: 'Weight' }
    & Pick<Weight, 'unit' | 'value'>
  )> }
);

export type WishlistFragmentFragment = (
  { __typename?: 'WishlistItem' }
...
export type AccountUpdateMutation = (
  ...
  & { accountUpdate?: Maybe<(
    ...
    & { accountErrors: Array<(
      { __typename?: 'AccountError' }
      & Pick<AccountError, 'code' | 'message'>
    )>, user?: Maybe<(
      { __typename?: 'User' }
...
export type AddToCartMutationVariables = Exact<{
  id: Scalars['ID'];
  input: Array<Maybe<CheckoutLineInput>> | Maybe<CheckoutLineInput>;
}>;
...
export type AddToCartMutation = (
  ...
  & { checkoutLinesAdd?: Maybe<(
    ...
    & { checkout?: Maybe<(
      ...
      { __typename?: 'CheckoutError' }
      & Pick<CheckoutError, 'code' | 'message'>
    )> }
  )> }
);
...
export type AddressCreateMutation = (
  ...
  & { operation?: Maybe<(
    ...
    & { address?: Maybe<(
      ...
      { __typename?: 'AccountError' }
      & Pick<AccountError, 'field' | 'code' | 'message'>
    )> }
  )> }
);
...
export type CreatePaymentMutation = (
  ...
  & { checkoutPaymentCreate?: Maybe<(
    ...
    & { payment?: Maybe<(
      { __typename?: 'Payment' }
      & Pick<Payment, 'id' | 'chargeStatus' | 'token'>
      & { order?: Maybe<(
        { __typename?: 'Order' }
        & Pick<Order, 'id' | 'token'>
      )> }
      ...
      { __typename?: 'PaymentError' }
      & Pick<PaymentError, 'field' | 'message'>
    )> }
  )> }
);
...
export type LoginMutationMutation = (
  ...
  & { tokenCreate?: Maybe<(
    ...
    & { user?: Maybe<(
      ...
      { __typename?: 'AccountError' }
      & Pick<AccountError, 'field' | 'message'>
    )> }
  )> }
);
...
export type CompletePaymentMutationVariables = Exact<{
  id: Scalars['ID'];
  input?: Maybe<Scalars['JSONString']>;
}>;
...
export type CompletePaymentMutation = (
  ...
  & { checkoutComplete?: Maybe<(
    ...
    & { order?: Maybe<(
      ...
      { __typename?: 'CheckoutError' }
      & Pick<CheckoutError, 'field' | 'message' | 'code'>
    )> }
  )> }
);
...
export type UpdateCartAddressesMutationVariables = Exact<{
  id: Scalars['ID'];
...
export type UpdateCartAddressesMutation = (
  { __typename?: 'Mutation' }
  & { shipping?: Maybe<(
    { __typename?: 'CheckoutShippingAddressUpdate' }
    & { checkout?: Maybe<(
...
export type UpdateDefaultAddressMutationVariables = Exact<{
  id: Scalars['ID'];
  type: AddressTypeEnum;
}>;
...
export type AccountRegisterMutationMutationVariables = Exact<{
  input: AccountRegisterInput;
}>;


export type AccountRegisterMutationMutation = (
  { __typename?: 'Mutation' }
  & { accountRegister?: Maybe<(
    ...
    & { accountErrors: Array<(
      { __typename?: 'AccountError' }
      & Pick<AccountError, 'field' | 'message' | 'code'>
    )>, user?: Maybe<(
      { __typename?: 'User' }
      & Pick<User, 'firstName' | 'lastName' | 'email'>
    )> }
...
export type RequestConfirmationEmailMutation = (
  { __typename?: 'Mutation' }
  & { requestConfirmationEmail?: Maybe<(
    { __typename?: 'ResendConfirmationEmail' }
    & Pick<ResendConfirmationEmail, 'status'>
  )> }
);
